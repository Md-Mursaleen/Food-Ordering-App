    ...
    return (
        <>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={
                    ...
                    <View style={
                        ...
                        <Text style={
                            ...
                            ⭐ {rating} ({review} reviews) • {categories}
                        </Text>
                    </View>
                    <Text style={
                        {
                ...
                <View style={
                    [styles.icecreamitemContainer, title === "Dessert" && { marginTop: 20 }]
                }>
                    <Text style={
                        {
                            marginLeft: 15,
                ...
                <View style={
                    [styles.chocolateitemContainer, title === "Dessert" && { marginTop: 10 }]
                }>
                    <Text style={
                        {
                            marginLeft: 15,
                ...
                <View style={
                    [styles.groceryitemContainer, title === "Dessert" && { marginTop: 8, marginBottom: 20 }]
                }>
                    <Text style={
                        {
                            marginLeft: 15,
