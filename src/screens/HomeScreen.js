...
function HomeScreen() {
    ...
    return (
        <>
            ...
            <View style={{ borderTopColor: "#eee", backgroundColor: "white", borderTopWidth: 1 }}>
                <BottomTabs />
            </View>
        </>
    );
