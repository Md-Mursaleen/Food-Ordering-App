    ...
    return (
        <>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                {image ? (
                    <Image source={{ uri: image }} style={
                        [styles.imageContainer, notfood && { resizeMode: "contain" }]
                    } />
                ) : (
                    <Image source={{ uri: restimage }} style={
                        {
                            width: "100%",
                            height: 300,
                            resizeMode: "contain"
                ...
                <Pressable style={
                    [styles.buttonContainer, notfood && { backgroundColor: "black" }]
                }
                ...
                {instruction && (
                    <View style={
                        [styles.instructionContainer, !information && { marginTop: 6 }]
                    }>
                        <View style={
                            {
                                marginLeft: 15,
                            ...
                            <View style={
                                ...
                                <TextInput style={
                                    ...
                                    keyboardType="default">Add a note (extra sauce, no onions, etc.)</TextInput>
                            </View>
                        </View>
                    </View>
                )}
                ...
                <View style={
                    [styles.menuContainer, description && { marginTop: 10 }]
                }>
                    <View style={
                        {
                            marginLeft: 15,
            ...
            <Pressable style={
                ...
                }>Add {quantity} to cart • {"\u00A3"}{getTotal()}</Text>
            </Pressable>
        </>
    );
}
