        ...
        <>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{ marginTop: 20 }}>
                ...
                <View style={styles.titleContainer}>
                    <Text style={styles.titleText}>Carts</Text>
                </View>
                {lastOrder.items ? (
                    ...
                    <View style={styles.contentContainer}>
                        ...
                        <Text style={styles.contentTitleText}>Add items to start a cart</Text>
                        <View style={{ alignItems: "center" }}>
                            <Text style={styles.contentDescriptionText}>Once you add items from a restaurant or store, </Text>
                            <Text style={styles.contentDescriptionText}>your cart will appear here.</Text>
                        </View>
                        <Pressable style={styles.contentButtonContainer}
